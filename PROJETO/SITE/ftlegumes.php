        ...
        <section class="flexmenu">
            <aside>
                <ul>
                    ...
                    <li class="column">
                        <a href="ftlegumes.php"><button class="menuvertical" id="menor">Legumes</button></a></li>
                    </li>
                    <li class="column">
                        <a href="ftverduras.php"><button class="menuvertical" id="menor">Verduras</button></a></li>
                    </li>
                </ul>
            </aside>
        </section>
