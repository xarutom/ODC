...
<body>
    <h1>Minha Empresa</h1><br>
    
    <form action="incluirFornecedor.php"  method="post">
        <p>DADOS PESSOA JURÍDICA</p><br>
        <input type="text" placeholder="CNPJ" name="cnpj">
        <br><br>
        <input type="text" placeholder="Inscrição Estadual" name="inscricaoEstadual">
        <br><br>
        <input type="text" placeholder="Nome Razao Social" name="razaoSocial">
        <br><br>
        ...
        <button type="submit"  class="btn" formaction="loginFornecedor.php">Sair</button>
    </form>
    <br>
    <p></p>
</body>
